...
if (isset($_POST['login'])) {
    ...
    $query = mysqli_query($con, "SELECT id, pass FROM tbl_user WHERE mail = '$mail'");
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.php" class="logo d-flex align-items-center w-auto">
                  <img src="assets/img/logo01.gif" alt="" style="width: 40px; height: 40px;">
                  <span class="d-none d-lg-block" style="text-align:center;">AI as a psychotherapist</span>
                </a>
              </div><!-- End Logo -->
